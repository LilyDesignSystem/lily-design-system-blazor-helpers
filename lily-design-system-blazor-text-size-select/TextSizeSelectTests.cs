...
public class TextSizeSelectTests : TestContext
{
    ...
    private IRenderedComponent<TextSizeSelect> RenderDefault()
        => RenderComponent<TextSizeSelect>(p => p
            .Add(x => x.Label, "Text size")
            .Add(x => x.Sizes, Sizes));

    private static void Key(IRenderedComponent<TextSizeSelect> cut, string selector, string key)
    ...
    public void Section_7_1_Renders_Button_Controlling_A_Listbox()
    {
        ...
        var root = cut.Find("div.text-size-select");
        Assert.NotNull(root);
    ...
    public void Section_7_2_Button_Renders_Glyph_Hidden_From_Assistive_Tech()
    {
        ...
        var icon = cut.Find(".text-size-select-icon");
        ...
        Assert.Equal("A", TextSizeSelect.LatinCapitalLetterA);
    }
    ...
    public async Task Section_7_4_One_Option_Per_Size_Hidden_Input_Carries_Name_And_Value()
    {
        ...
        var options = cut.FindAll("li.text-size-select-option");
    ...
    public void Section_7_7_Default_Labels_TitleCase_And_Overrideable()
    {
        ...
        var labels = cut.FindAll("li.text-size-select-option")
        ...
        var labels2 = cut2.FindAll("li.text-size-select-option")
            .Select(li => li.TextContent.Trim()).ToList();
    ...
    public void Section_7_8_Option_Ids_Are_Stable_And_Unique_Per_Instance()
    {
        ...
        Assert.StartsWith("text-size-select-", aList);
    ...
    public async Task Section_7_17_Focus_Leaving_The_Root_Closes_The_Listbox()
    {
        ...
        cut.Find("div.text-size-select").FocusOut();
        cut.Find("div.text-size-select").FocusOut();
    ...
    public async Task Section_7_19_Applies_DataTextSize_On_First_Render()
    {
        ...
        Assert.Contains("setAttribute('data-text-size',\"large\")",
            TextSizeSelect.BuildApplyScript("large", storageKey: null));
    }
    ...
    {
        Assert.Equal("X Large", TextSizeSelect.SizeName("x-large"));
        Assert.Equal("Medium", TextSizeSelect.SizeName("medium"));
        Assert.Equal("Extra Extra Large", TextSizeSelect.SizeName("extra-extra-large"));
        Assert.Equal("", TextSizeSelect.SizeName(""));
        ...
        var labels = cut.FindAll("li.text-size-select-option")
            .Select(li => li.TextContent.Trim()).ToList();
        Assert.Equal(
            new[] { TextSizeSelect.SizeName("x-large"), TextSizeSelect.SizeName("medium") },
            labels);
    }
    ...
    public void Section_7_23_AdditionalAttributes_Spread_Onto_The_Root()
    {
        ...
        Assert.Equal("ts", cut.Find("div.text-size-select").GetAttribute("data-testid"));
    }
    ...
    public async Task Section_7_24_ChildContent_Replaces_The_Glyph_And_Receives_Context()
    {
        ...
        Assert.Empty(cut.FindAll(".text-size-select-icon"));

        var custom_ = cut.Find("[data-testid='custom']");
        Assert.Contains("text-size-select-button",
