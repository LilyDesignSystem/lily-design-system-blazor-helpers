// ThemePicker — code-behind. See spec.md for the contract.
...
public partial class ThemePicker : ComponentBase
{
    ...
    /// <summary>Shared <c>name</c> attribute for the radio inputs and the
    ...
    private string LabelFor(string theme)
    {
        ...
        return char.ToUpperInvariant(theme[0]) + theme[1..];
    }
    ...
    private Task OnInputChangeAsync(string slug) => SetThemeAsync(slug);
