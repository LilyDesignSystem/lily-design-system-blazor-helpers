# Lily Design System — Blazor 10 Helpers — Specification

Spec-driven plan and task list for the Blazor 10 helpers catalog. This file is
...
The helpers catalog ships a small set of opinionated, reusable Blazor 10
...
- SSR / prerender safety; framework-idiomatic Blazor 10 source.
...
| Helper | Purpose |
| ------ | ------- |
| [`lily-design-system-blazor-theme-chooser`](../lily-design-system-blazor-theme-chooser/) | Pick a visual theme; dynamic CSS load + `data-theme` swap, optional persistence. |
...
- .csproj (Razor class library) — package manifest.
...
- Component source: `{Pascal}.razor`, `{Pascal}.razor.cs`, `{Pascal}Tests.cs`.
- `docs/` and `examples/` — topic guides and runnable examples.
- Tests: bUnit + xUnit — one test per numbered §7 acceptance in the helper's spec.
...
- [x] Each helper has its component source, tests, `spec/index.md`, and .csproj (Razor class library).
...
Both helpers are implemented with Blazor 10 source, tests, docs, and a package
manifest. The catalog mirrors the canonical
[`lily-design-system-svelte-helpers`](../../lily-design-system-svelte-helpers/)
reference with Blazor 10 idioms substituted.

## 8. References

- Canonical reference catalog: [`lily-design-system-svelte-helpers`](../../lily-design-system-svelte-helpers/).
- Headless sibling: [`lily-design-system-blazor-headless`](../../lily-design-system-blazor-headless/).
