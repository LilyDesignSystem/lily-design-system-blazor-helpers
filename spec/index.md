...
| Helper                                                                                   | Purpose                                                                          |
| ---------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| [`lily-design-system-blazor-theme-picker`](../lily-design-system-blazor-theme-picker/)   | Pick a visual theme; dynamic CSS load + `data-theme` swap, optional persistence. |
