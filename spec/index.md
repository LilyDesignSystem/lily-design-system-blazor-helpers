...
| Helper | Purpose |
| ------ | ------- |
| [`lily-design-system-blazor-theme-select`](../lily-design-system-blazor-theme-select/) | Pick a visual theme; dynamic CSS load + `data-theme` swap, optional persistence. |
