// ShareButton — code-behind. See spec/index.md for the contract.
...
public partial class ShareButton : ComponentBase
{
    ...
    /// monochrome alongside ThemeSelect's ◑, LocaleSelect's 🌐 and
    /// TextSizeSelect's "A".
    /// </remarks>
    ...
    [Parameter] public RenderFragment<ShareButtonContext>? ChildContent { get; set; }
    ...
    private readonly string _baseId = NextShareButtonId();
    ...
    private string RootClass => $"share-button {CssClass}".Trim();
    ...
    private ShareButtonContext BuildContext() => new()
    {
        Open = _open,
        Url = CurrentUrl(),
    };
    ...
    public static string NextShareButtonId()
        => $"share-button-{Interlocked.Increment(ref _uid)}";
