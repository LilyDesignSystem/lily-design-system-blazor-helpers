...
`lily-design-system-blazor-share-button`. Each file is a runnable
...
| 3 | [`CustomGlyph.razor`](./CustomGlyph.razor) | `RenderFragment<ShareButtonContext>` — custom button face, state-aware. |
...
2. Add a project reference to
   `LilyDesignSystem.Blazor.ShareButton.csproj`.
