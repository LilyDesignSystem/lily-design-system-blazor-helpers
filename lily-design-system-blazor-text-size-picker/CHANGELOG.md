...
- **Default icon changed from a Unicode glyph to a bundled SVG.** The
  ...
  (stroke-drawn "A" design, `stroke="currentColor"`, `stroke-width="1.6"`,
  ...
  maintain. The public constant **`LatinCapitalLetterA`** (A
  U+0041) is **removed, not renamed** — there is no longer a
