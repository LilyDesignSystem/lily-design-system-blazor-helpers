# Testing — ThemeSelect (Blazor)

The select's test suite lives in
[`../ThemeSelectTests.cs`](../ThemeSelectTests.cs) and asserts every
...
```csharp
var script = ThemeSelect.BuildApplyScript("theme", "/t/dark.css", "dark", "lily-theme");
