...
```razor
<LocaleSelect Label="Language" Locales="@codes"
...
```razor
<LocaleSelect Label="Language" Locales="@codes" ApplyDir="false" @bind-Value="locale" />
```
...
```razor
<LocaleSelect @ref="localeSelect" Label="Language" Locales="@codes"
