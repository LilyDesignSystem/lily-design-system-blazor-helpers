...
public class LocaleSelectTests : TestContext
{
    ...
    private IRenderedComponent<LocaleSelect> RenderDefault()
        => RenderComponent<LocaleSelect>(p => p
    ...
    public void Section_7_5_Option_Lang_Is_Bcp47_Hyphen()
    {
        ...
        var options = cut.FindAll(".locale-select-option");
    ...
    public void Section_7_9_Option_Ids_Are_Stable_And_Unique_Per_Instance()
    {
        ...
        Assert.StartsWith("locale-select-", aList);
    ...
    public async Task Section_7_18_Focus_Leaving_The_Root_Closes_The_Listbox()
    {
        ...
        cut.Find("div.locale-select").FocusOut();
        cut.Find("div.locale-select").FocusOut();
    ...
    public void Section_7_23_Apply_Script_Sets_Lang_To_Bcp47_Tag()
    {
        Assert.Contains("setAttribute('lang',\"en-US\")",
            LocaleSelect.BuildApplyScript("en_US", applyDir: true, storageKey: null));
        Assert.Contains("setAttribute('lang',\"zh-Hant-TW\")",
            LocaleSelect.BuildApplyScript("zh_Hant_TW", applyDir: true, storageKey: null));
    }
    ...
    public void Section_7_24_Apply_Script_Dir_Handling()
    {
        ...
        Assert.Contains("setAttribute('dir',\"ltr\")",
            LocaleSelect.BuildApplyScript("en", applyDir: true, storageKey: null));
    ...
    public void Section_7_28_AdditionalAttributes_Spread_Onto_The_Root()
    {
        ...
        Assert.Equal("ls", cut.Find("div.locale-select").GetAttribute("data-testid"));
    }
